...
#define       READ_CYLINDER_OUTER        READ_BAFFLE_OUTER  //返回的是一个字节，读的是一个位
#define       READ_CYLINDER_INTER        READ_BAFFLE_INTER //返回的是一个字节，读的是一个位
...
#define       CYLINDER_INTER             BAFFLE_INTER
#define       CYLINDER_OUTER             BAFFLE_OUTER
