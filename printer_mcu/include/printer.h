...
#define       PRINTER_START_OFF   		GPIO_SetBits(PRINTER_START_PORT, PRINTER_START_IO)
#define       PRINTER_START_ON  			GPIO_ResetBits(PRINTER_START_PORT, PRINTER_START_IO)
#define       PRINTER_RESTART_OFF   	GPIO_SetBits(PRINTER_RESTART_PORT, PRINTER_RESTART_IO)
#define       PRINTER_RESTART_ON 	 	 	GPIO_ResetBits(PRINTER_RESTART_PORT,PRINTER_RESTART_IO)
