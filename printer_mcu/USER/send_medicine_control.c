...
static void CH1_Send_Medicine(void)
{
    ...
    switch (Channel.ch1.state) {
        case RESERVE:
            ...
            break;
        case READY:
            if ((Channel.ch2.motor_start_state != 1) && (Channel.ch3.motor_start_state != 1) && (Channel.ch4.motor_start_state != 1)) {
        ...
        case WORKEND:
            ...
            break ;
        case END:
            if ((READ_DEVICE1_KEY == READLOW) && (READ_DEVICE1_SENSOR2 == READHIGH)) {  //发药完成或者空闲时可以复位
                delay_ms(1);
                if ((READ_DEVICE1_KEY == READLOW) && (READ_DEVICE1_SENSOR2 == READHIGH)) {
                    DEVICE1_MOTOR_RUN;
                    Channel.ch1.motor_state = 1;
...
static void CH2_Send_Medicine(void)
{
    ...
    switch (Channel.ch2.state) {
        case RESERVE:
            ...
            break;
        case READY:
            if ((Channel.ch1.motor_start_state != 1) && (Channel.ch3.motor_start_state != 1) && (Channel.ch4.motor_start_state != 1)) {
        ...
        case WORKEND:
            ...
            break ;
        case END:
            if ((READ_DEVICE2_KEY == READLOW) && (READ_DEVICE2_SENSOR2 == READHIGH)) {    //发药完成或者空闲时可以复位
                delay_ms(1);
                if ((READ_DEVICE2_KEY == READLOW) && (READ_DEVICE2_SENSOR2 == READHIGH)) {
                    DEVICE2_MOTOR_RUN;
                    Channel.ch2.motor_state = 1;
...
static void CH3_Send_Medicine(void)
{
    ...
    switch (Channel.ch3.state) {
        case RESERVE:
            ...
            break;
        case READY:
            if ((Channel.ch2.motor_start_state != 1) && (Channel.ch1.motor_start_state != 1) && (Channel.ch4.motor_start_state != 1)) {
        ...
        case WORKEND:
            ...
            break ;
        case END:
            if ((READ_DEVICE3_KEY == READLOW) && (READ_DEVICE3_SENSOR2 == READHIGH)) {  //发药完成或者空闲时可以复位
                delay_ms(1);
                if ((READ_DEVICE3_KEY == READLOW) && (READ_DEVICE3_SENSOR2 == READHIGH)) {
                    DEVICE3_MOTOR_RUN;
                    Channel.ch3.motor_state = 1;
...
static void CH4_Send_Medicine(void)
{
    ...
    switch (Channel.ch4.state) {
        case RESERVE:
            ...
            break;
        case READY:
            if ((Channel.ch2.motor_start_state != 1) && (Channel.ch3.motor_start_state != 1) && (Channel.ch1.motor_start_state != 1)) {
        ...
        case WORKEND:
            ...
            break ;
        case END:
            if ((READ_DEVICE4_KEY == READLOW) && (READ_DEVICE4_SENSOR2 == READHIGH)) {  //发药完成或者空闲时可以复位
                delay_ms(1);
                if ((READ_DEVICE4_KEY == READLOW) && (READ_DEVICE4_SENSOR2 == READHIGH)) {
                    DEVICE4_MOTOR_RUN;
                    Channel.ch4.motor_state = 1;
