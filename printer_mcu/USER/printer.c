...
{	
  ...
  PRINTER_RESTART_OFF;//´òÓ¡»úÖØÆôĞÅºÅ¸ÄÎª¾íÖ½µç»úÆô¶¯ĞÅºÅÓÃ£¬´òÓ¡µÄÊ±ºò¾ÍÆô¶¯¾íÖ½¡£
	...
	switch(Printer.process){
		...
		case PRINTER_READY:   
														if(Printer.fluid_bag_timeout==0){
															...
															if(1 == Read_Baffle_State()){ //Ã»´òÓ¡Ç°½ÓÊÕµ½É¨ÃèÇ¹´íÎó£¬ÂíÉÏÍ£Ö¹
                                ...
                                uiRoll_Paper_ON_Delay = 400;//¾íÖ½µç»ú¿ªÆô×î´óÑÓÊ±2S£¬Õı³£¾íÖ½µç»úÍ£Ö¹Ó¦¸ÃÊÇÆø¸×ÏÂÑ¹Ê±
